...
try {
  if (!fs.existsSync(sourceNodeModules)) {
    console.log('[link-root-node-modules] admin/node_modules not found, skipping')
    process.exit(0)
  }
  ...
  console.log('[link-root-node-modules] linked root node_modules -> admin/node_modules')
} catch (error) {
