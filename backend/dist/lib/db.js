...
const FALLBACK_URI = 'mongodb+srv://amirfaisallinkon2_db_user:vJud10ZGDEtAYDim@tinybites.prcyth4.mongodb.net/?appName=tinyBites';
...
const getMongoConfig = () => {
    ...
    if (!uri)
        throw new Error('Missing MONGODB_URI (and no fallback available)');
    return { uri, dbName };
};
